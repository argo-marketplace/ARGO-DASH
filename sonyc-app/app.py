...
map_data = pd.read_csv('https://raw.githubusercontent.com/argo-marketplace/DASH-app/master/SONYC_Dataset.csv?token=AVEIoWLQBJGTIBQ5EYY8VC0d8WDT2ux8ks5aNpxwwA%3D%3D')
